...
<center><div class="row" style="width: 100%; height: 100%;">
  <div class="col-md-12">
    ...
    <div class="mdb-lightbox no-margin">
                    ...
                    <figure class="col-md-4" style="text-align: center; width: 60%; height: 60%">

                    	<img src="{{ asset($modeloTyCProducto->rutas_imagenes) }}" class="img-fluid" style="width: 100%; height: 100%;margin: 0.1%; " />
                    ...
                    <figure class="col-md-4">
                    		...
                    		<h1 ALIGN="center" style="font-size: 150%; font-family: Arial; text-align: left;" ><strong>{{$modeloTyCProducto->nombres}}</strong></h1>

                        <h1 ALIGN="center" style="font-size: 150%; font-family: Arial; text-align: left;" ><strong>Codigo:  {{$modeloTyCProducto->codigos}}</strong></h1>

                        <hr style="color:#000000;"/>

                    		<br>
                      
                        	<p ALIGN="justify" style="font-size: 150%; font-family: Arial;" ><strong>{{$modeloTyCProducto->descripciones}}</strong></p>

                        	<h1 ALIGN="justify" style="font-size: 150%; font-family: Arial;" ><strong>Cantidades: {{$modeloTyCProducto->cantidades}}</strong></h1>

                          <h1 ALIGN="justify" style="font-size: 150%; font-family: Arial;" ><strong>Precios: ${{$modeloTyCProducto->precios}}</strong></h1>

                          <form action="{{ url('/AgregarCarrito') }}" method="post" enctype="multipart/form-data">

                            <input type="hidden" name="_token" value="{{ csrf_token() }}">

                            <input type="hidden" name="idProducto" value="{{$modeloTyCProducto->id}}">

                            <input type="hidden" name="codigoProducto" value="{{$modeloTyCProducto->codigos}}">

                            <input type="number" name="cantidadProductos" required>
