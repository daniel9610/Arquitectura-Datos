...
<div class="login-logo">
  <b>OPCION DEL PRODUCTO</b>
</div>


<center><div class="row" style="width: 32%;">
    <div class="col-xs-12" >
        <div class="table-responsive no-padding">
          <table class="table table-hover" >
            <tr>
              ...
              @foreach ($modeloTyCProducto as $u )
              <tr>
                    <td>{{$u->nombres}}</td>
                    <td><button type="button" class="btn" onclick="location.href='{{ url('/EliminarProductos/'.$u->id.'/') }}'">Eliminar Producto</button></td>

                    <td><button type="button" class="btn" onclick="location.href='{{ url('/ModificarProductos/'.$u->id.'/') }}'">Modificar Producto</button></td>
              </tr>
              @endforeach
