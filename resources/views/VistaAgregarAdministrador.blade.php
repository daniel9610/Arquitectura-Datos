    ...
    <div style="width: 50%;height: 50%;">
            ...
            <div class="login-box-body">
                ...
                <form action="{{ url('/register') }}" method="post">
                    ...
                    <div class="form-group has-feedback">
                      <label style="color:#000000;font-size: 120%;">Contraseña</label>
                        <input type="password" class="form-control" placeholder="{{ trans('adminlte_lang::message.password') }}" name="password"/>
                        <span class="glyphicon glyphicon-lock form-control-feedback"></span>
                    </div>
                    <div class="form-group has-feedback">
                      <label style="color:#000000;font-size: 120%;">Confirmar contraseña</label>
                    ...
                    <div class="row" style="width: 100%;">
                        ...
                        <div class="col-xs-4 col-xs-push-1" style="width: 85%;">
                            <button type="submit" class="btn btn-primary btn-block btn-flat" style="width: 50%;text-align: center;">{{ trans('adminlte_lang::message.register') }}</button>
                        </div><!-- /.col -->
                    </div>
                </form>
