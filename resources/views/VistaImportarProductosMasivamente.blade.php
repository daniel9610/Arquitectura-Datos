...
<center><div class="row">
<div class="btn-group-vertical">
    <center><form action="{{ url('/ImportarPrudctosMasivamente') }}" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                    <div class="form-group has-feedback">

                        <label style="color:#000000;font-size: 120%;">Agregar comentarios</label>
                        <input type="text" class="form-control" placeholder="Comentario" name="comentario" required autofocus/>

                        <br></br>
                        <label style="color:#000000;font-size: 120%;">Adjuntar excel</label>
                        <center><input name="UrlImg1" type="file" class="bg-light-blue color-palette" placeholder="Agregar Imagen" required></center>
                        
                        <br></br>
                        <label style="color:#000000;font-size: 120%;">Adjuntar imagen de los productos</label>
                        <center><input required type="file" class="form-control" name="images[]" placeholder="address" multiple></center>
                        
                    </div>

                        <div class="col-xs-4 col-xs-push-1" style="width: 85%;">
                            <button type="submit" class="btn" style="text-align: center;">Importar productos</button>
                        </div>
                </form> </center>
    </div>
</div></center>
