        ...
        <div class="table-responsive no-padding">
          <table class="table table-hover" >
            <tr>
              ...
              @foreach ($modeloUser as $u )
              <tr>
                    <td>{{$u->name}}</td>
                    <td>{{$u->email}}</td>
                    <td><button type="button" class="btn" onclick="location.href='{{ url('/ModificarAdministrador/'.$u->id.'/') }}'">Modificar Administrador</button></td>
              </tr>
              @endforeach
